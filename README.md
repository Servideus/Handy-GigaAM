...
> Key fork differences: added GigaAM v3 e2e-CTC models (compressed/int8 and full), Russian-focused model options, and release workflow updates for optional Windows signing.
